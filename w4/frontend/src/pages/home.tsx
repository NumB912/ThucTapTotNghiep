  ...
  useEffect(() => {
    const getData = async () => {
      try {
        setLoading(true);
        const response = await apiFetch(
          `people/day/${formatDateLocal(selectedDate)}`
        );
                ...
                (() => {
                  ...
                  return isToday ? (
                    ...
                    <p className="text-2xl font-bold mb-5">
                      ...
                      {String(eventDate.getMonth() + 1).padStart(2, "0")} có gì
                      nhé
                    </p>
                  );
                })()}
          ...
          {loading ? (
            ...
            <>
              {selectedDate &&
                (() => {
                  ...
                  return isToday ? (
                    ...
                    <p className="text-2xl font-bold mb-5">
                      Danh nhân lịch sử {daysOfWeek[eventDate.getDay()]},{" "}
                      {String(eventDate.getDate()).padStart(2, "0")}/
              ...
              <div className="grid grid-cols-3 gap-5">
                {
                  people.map(person=>{
                    return <CardPersonChild person={person}/>
                  })
