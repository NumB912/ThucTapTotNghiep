          ...
          <div className="py-2 flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <p className="text-[10px]">
                Số lượng câu:{" "}
                <span className="font-bold text-blue-500">{questionResult?.questionQuantity}</span>
              </p>

              <p className="text-[10px]">
                Số lượng câu đúng:{" "}
                <span className="font-bold text-green-500">{questionResult?.score}</span>
              </p>

              <p className="text-[10px]">
                Số lượng câu sai:{" "}
                <span className="font-bold text-red-500">{(questionResult?.questionQuantity ?? 0) - (questionResult?.score ?? 0)}</span>
              </p>
